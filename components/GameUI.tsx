            ...
            {upgradeChoices.length > 0 ? upgradeChoices.map((choice) => {
              ...
              return (
                <button key={choice.id} onClick={() => onSelectUpgrade(choice)}
                  className="btn-stone flex-1 min-h-[460px] px-10 pb-10 pt-16 flex flex-col items-center text-center transition-all group overflow-hidden relative border-2 border-purple-500/70 rounded-2xl">
                  <div className="metal-shine"></div>
