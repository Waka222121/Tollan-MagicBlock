...
export class EnemyManager {
  ...
  private castChainLightningAbility(boss: any, bossData: any, stats: any, player: any) {
    ...
    const warn = (this.scene.add as any).ellipse(targetX, targetY, 68, 68, 0xff2200, 0.16)
      .setDepth(209)
      .setStrokeStyle(3, 0xff2200, 1);
    this.scene.tweens.add({ targets: warn, alpha: 0.95, scaleX: 1.6, scaleY: 1.6, duration: 320, yoyo: true, onComplete: () => warn.destroy() });
    ...
    lightningArc.lineStyle(6, 0xff2200, 0.98);
    lightningGlow.lineStyle(12, 0xff2200, 0.28);
